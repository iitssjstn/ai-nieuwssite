...
//
// read() geeft bewust een structuredClone() van de cache terug (geen
// directe referentie) — dat is puur in-memory-werk, geen schijftoegang, dus
// nog steeds veel sneller dan opnieuw inlezen, maar het houdt het overal in
// deze file gebruikte patroon van "read() -> muteer het object -> write()"
// exact hetzelfde en even veilig als voorheen: elke aanroeper werkt met
// zijn eigen kopie totdat write() die daadwerkelijk persisteert én de
// gedeelde cache bijwerkt.
let cache = null;
...
<h2>Cookies</h2>
<p>We plaatsen zelf geen tracking- of marketingcookies. Het enige cookie dat we zelf zetten is het functionele stem-cookie hierboven.</p>
<p><strong>Advertenties:</strong> als je toestemming geeft via de cookiemelding op de site, kunnen advertentienetwerken (zoals Google AdSense) eigen cookies plaatsen voor het tonen van advertenties. Geef je geen toestemming, dan laden deze scripts niet.</p>
<h2>Jouw rechten</h2>
