...
// Checkt of het huidige moment (in Nederlandse tijd) binnen het ingestelde
// actieve tijdvenster valt. Ondersteunt ook een venster dat over middernacht
// heen loopt (bijv. start "22:00", eind "06:00").
export function isWithinActiveHours({ active_hours_enabled, active_hours_start, active_hours_end }) {
  ...
  const nowStr = new Intl.DateTimeFormat("nl-NL", {
...
// Ezoic vraagt geen site-specifieke ID in het scriptje zelf — de koppeling
// gebeurt via domeinverificatie in hun eigen dashboard. Hier dus alleen een
// simpele aan/uit-schakelaar.
