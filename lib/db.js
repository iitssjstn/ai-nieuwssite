...
export function setAutomationSettings({ enabled, max_per_source, auto_publish, auto_publish_min_confidence, auto_gather_sources, auto_update_published, auto_update_min_confidence }) {
  const data = read();
  data.settings = data.settings || {};
