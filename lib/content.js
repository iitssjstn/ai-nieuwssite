...
// Zoekt de door de admin ingestelde kleur op voor een categorienaam (uit
// Instellingen → Categorieën) en zet die om naar een badge-stijl — een
// lichte tint van de kleur als achtergrond, de volle kleur als tekst. Werkt
// zo automatisch met elke zelf-aangemaakte categorie, niet alleen de vijf
// standaardnamen.
...
// Schat de leestijd op basis van het aantal woorden (uitgaande van
// ~200 woorden per minuut, een gangbare vuistregel voor Nederlandse tekst).
export function getReadingTime(body) {
  if (!body) return "1 min leestijd";
