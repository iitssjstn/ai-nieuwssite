...
// Knipt op de laatste spatie vóór maxLen af i.p.v. hard midden-in-een-woord
// — een afgekapt woord in Google's meta-description oogt slordig en kan de
// klikfrequentie (CTR) drukken, wat weer een indirect rankingsignaal is.
...
export function getExcerpt(body, maxLen = 160) {
  ...
  return truncateAtWord(body.split("\n")[0].trim(), maxLen);
}
