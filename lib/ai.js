...
// Eenmalige migratiefunctie: vertaalt een bestaand Nederlands artikel naar
// het Engels. Losstaand van translateArticle hierboven (die inmiddels
// van Engels NAAR andere talen vertaalt, sinds de site zelf Engels werd) —
// deze functie is specifiek voor scripts/migrate-translate-articles.mjs en
// kan verwijderd worden zodra die migratie is afgerond.
...
export async function translateArticleToEnglish({ title, body }) {
  const userPrompt = `Title: ${title}\n\nText:\n${body}`;
