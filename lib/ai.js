...
{"title": "...", "body": "...", "category": "${exampleCategory}", "image_keywords": "...", "claims": [{"text": "...", "verified": true}], "location_hint": "..."}`;
}
...
{"title": "...", "body": "...", "category": "${exampleCategory}", "consistency_notes": ["...", ...], "image_keywords": "...", "claims": [{"text": "...", "verified": true}], "location_hint": "..."}`;
}
