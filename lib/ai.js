...
const SOCIAL_POSTS_PROMPT = `Je bent een social-media-redacteur voor een nieuwssite. Op basis van de
aangeleverde titel en tekst, schrijf je drie korte, platform-passende posts om dit artikel te promoten:
...
const PUSH_NOTIFICATION_PROMPT = `Je bent een nieuwsredacteur die pushmeldingen schrijft. Op basis van de
...
const NEWSLETTER_PROMPT = `Je bent een nieuwsredacteur die een nieuwsbrief samenstelt. Schrijf op basis van
